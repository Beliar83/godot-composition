...
### GodotCompositionSourceGenerator
...
### GodotCompositionSourceGenerator.Sample

A project that references source generators. Note the parameters of `ProjectReference`
in [GodotCompositionSourceGenerator.Sample.csproj](../GodotCompositionSourceGenerator.Sample/GodotCompositionSourceGenerator.Sample.csproj),
they make sure that the project is referenced as a set of source generators.

### GodotCompositionSourceGenerator.Tests
