...
{
    public const string WRAPPERS_DIR_NAME = "addons/godot_composition_cs/GDExtensionWrappers";
    public const string WRAPPERSTest_DIR_NAME = "addons/godot_composition_cs/GDExtensionWrappers.Tests";
