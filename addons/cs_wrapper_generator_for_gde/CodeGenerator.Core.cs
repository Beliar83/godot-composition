...
{
    private static void GenerateSourceCodeForType(bool includeTests,
        ...
        ConcurrentDictionary<string, ConcurrentBag<FileData>> files, string[] gdeTypeNames) =>
        GenerateCode(
            includeTests,
            gdeTypeInfo,
            inheritanceMap,
    ...
    private static void GenerateCode(bool includeTests,
        ClassInfo gdeTypeInfo,
        IReadOnlyDictionary<string, ClassInfo> inheritanceMap,
        IReadOnlyDictionary<string, string> godotSharpTypeNameMap,
        ICollection<string> godotBuiltinClassNames,
        ...
        ConcurrentDictionary<string, ConcurrentBag<FileData>> files, string[] gdeTypeNames)
    {
        ...
        codeBuilder.AppendLine(
            $$"""
              ...
              {{TAB3}}? {{STATIC_HELPER_CLASS}}.{{VariantToInstanceMethodName}}<{{displayTypeName}}>(godotObject)
              {{TAB3}}: null;
              {{TAB1}}}
              """
        );
    ...
    private static void GenerateMembers(bool isAbstract,
        ...
        string backingName, string[] gdeTypeNames)
    {
        ...
        ConstructProperties(occupiedNames, propertyInfoList, godotSharpTypeNameMap, inheritanceMap, nativeNameCache, propertiesBuilder, backingName, gdeTypeNames);
        ConstructMethods(occupiedNames, methodInfoList, godotSharpTypeNameMap, inheritanceMap, godotBuiltinClassNames, nativeNameCache, methodsBuilder, gdeTypeInfo, backingName, gdeTypeNames);
